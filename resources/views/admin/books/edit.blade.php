    ...
    <div class="card-body">
      <form action="{{ route('books.show', $book) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-6">
            <input id="cover_image" accept="image/*" onchange="readCoverImage(this);" type="file" class="form-control @error('cover_image') is-invalid @enderror" name="cover_image" value="{{ $book->cover_image }}" autocomplete="cover_image">
            @error('cover_image')
            <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        ...
        <div class="form-group row">
          ...
          <div class="col-md-6">
            <select name="publisher" id="publisher" class="form-control">
              <option disabled {{ $book->publisher == null ? "selected" : "" }}>اختر ناشر</option>
